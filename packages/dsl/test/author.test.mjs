...
const backed = [
  ...
  ['No terminal node sits inside a map, loop, parallel branch, route/dispatch branch or child workflow', doc({ node: 'loop', label: 'l', body: { node: 'report', label: 'r', instructions: 'Render.' }, until: { predicate: 'field_true', path: 'done' }, maxIters: 2 }), /cannot live inside a loop body/],
