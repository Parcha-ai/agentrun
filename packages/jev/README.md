...
```sh
npm install @parcha/agentrun-dsl @parcha/agentrun-jev
...
The [standalone TypeScript starter](../../examples/starter/README.md) includes unpublished local-tarball installation, a complete search-and-screen workflow, and tests for missing evidence and the screening step alone. Its injected client answers every named question generated by `sift`.
...
The [support integration example](../../docs/support-quickstart.md) returns a validated answer or escalation from a callable function. Register it as a tool in your application. Your host controls the surrounding agent loop, tool permissions and delivery.
