...
const paths = ['packages/dsl/schema', 'docs/dependencies.md', 'packages/pi/src/demo-data.ts', 'packages/pi/skills/author/references/dsl-contract.md', 'packages/pi/skills/author/references/jev-decisions.md'];
